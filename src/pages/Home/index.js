...
import sprTexturePlaceholder from 'assets/spr.png';
import sprTexture from 'assets/spr.png';
...
import sliceTexture from 'assets/slice.png';
import sliceTextureLarge from 'assets/slice.png';
...
const Home = () => {
  ...
  return (
    <div className="home">
      <Helmet>
        <title>Danish Akhter | Designer + Developer</title>
        <meta
          name="description"
          content="Portfolio of Danish Akhter – a digital designer working on web &amp; mobile
